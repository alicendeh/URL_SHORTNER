import bg_boost_desktop from "./bg-boost-desktop.svg";
import bg_boost_mobile from "./bg-boost-mobile.svg";
import bg_shorten_desktop from "./bg-shorten-desktop.svg";
import bg_shorten_mobile from "./bg-shorten-mobile.svg";
